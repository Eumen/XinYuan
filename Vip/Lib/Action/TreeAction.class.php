...
class TreeAction extends CommonAction {
	...
	public function ajax_tree_m() {
		...
		foreach ( $z_tree as $zzzz ) {
			...
			$zzz_str .= '<p>' . $zzzz [2] . $zzzz [0] . '</p>' . '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="' . $zzzz [1] . '" class="treep2">' . '<tr><td id="' . $zzzz [1] . '_tree">' . $ttt_nnn . '<img src="' . __PUBLIC__ . '/Images/loading2.gif" align="absmiddle"></td>' . '</tr></table>';
		}
