...
CREATE TABLE `xy_address` (
  ...
  `updateflg` varchar(255) DEFAULT '0' COMMENT '更新标志',
  `updatetime` varchar(255) DEFAULT '' COMMENT '更新时间',
  `deleteflg` varchar(255) DEFAULT '0' COMMENT '删除标志',
  `deletetime` varchar(255) DEFAULT '' COMMENT '删除时间',
...
CREATE TABLE `xy_bonussummary` (
  ...
  `updateflg` varchar(255) DEFAULT NULL COMMENT '更新标志',
  `deleteflg` varchar(255) DEFAULT NULL COMMENT '删除标志',
  `time` varchar(255) DEFAULT NULL COMMENT '结算时间',
  `updatetime` varchar(255) DEFAULT NULL COMMENT '更新时间',
  `deletetime` varchar(255) DEFAULT NULL COMMENT '删除时间',
...
CREATE TABLE `xy_member` (
  ...
  `recommendSum` varchar(255) DEFAULT NULL COMMENT '推荐人数',
  `teamSum` varchar(255) DEFAULT NULL COMMENT '团队人数',
  ...
  `updateflg` varchar(255) DEFAULT NULL COMMENT '更新标志：0：未更新1：已更新',
  `updatetime` varchar(255) DEFAULT NULL COMMENT '更新时间',
  `deleteflg` varchar(255) DEFAULT NULL COMMENT '删除标志',
  `deletetime` varchar(255) DEFAULT NULL COMMENT '删除时间',
...
CREATE TABLE `xy_personbonusdetail` (
  ...
  `type` varchar(255) DEFAULT NULL COMMENT '奖金类型',
...
CREATE TABLE `xy_product` (
  ...
  `count` varchar(255) DEFAULT NULL COMMENT '库存',
  `updateflg` varchar(255) DEFAULT NULL COMMENT '更新标志',
  `deleteflg` varchar(255) DEFAULT NULL COMMENT '删除标志',
  `updatetime` varchar(255) DEFAULT NULL COMMENT '更新时间',
  `deletetime` varchar(255) DEFAULT NULL COMMENT '删除时间',
